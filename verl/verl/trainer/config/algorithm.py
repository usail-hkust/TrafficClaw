...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        reward_std_filter_threshold (Optional[float]): If set, filter out prompt groups whose reward std
            is <= this threshold before PPO update. Only groups with high reward variance are trained on.
            Default None means no filtering.
    """
    ...
    reward_std_filter_threshold: Optional[float] = None
